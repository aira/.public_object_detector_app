...
PATH_TO_CKPT = os.path.join(BASE_PATH, 'object_detection', MODEL_NAME, 'frozen_inference_graph.pb')

# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = os.path.join(BASE_PATH, 'object_detection', 'data', 'mscoco_label_map.pbtxt')
...
def detect_objects(image_np, sess, detection_graph, utterance_frames=20):
    ...
    if not update_state.row % utterance_frames:
